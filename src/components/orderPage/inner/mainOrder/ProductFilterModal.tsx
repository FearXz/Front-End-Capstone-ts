    ...
    <div>
      {newProduct && (
        <Modal dialogClassName="rounded-0" show={p.show} onHide={p.handleClose} backdrop="static" keyboard={false}>
          ...
          <Modal.Body>
            {newProduct.ingredienti.length != 0 ? (
              ...
              <p>Vuoi aggiungere {newProduct.nomeProdotto} al carrello ?</p>
            )}
          </Modal.Body>
          <Modal.Footer className=" justify-content-between">
            ...
            <Row>
              <Col className="col-4 px-0 d-flex align-items-end">
                <button
                  className="btn btn-outline-danger w-100  rounded-0"
                  onClick={() => dispatch(minusQuantityNewProduct())}
                >
                  -
                </button>
              </Col>
              <Col className="col-4 px-0 d-flex align-items-end">
                <button className="w-100 h-100 btn btn-light rounded-0 ">{newProduct.quantita}</button>
              </Col>
              <Col className="col-4 px-0 d-flex align-items-end">
                <button
                  className="btn btn-outline-success w-100  rounded-0"
                  onClick={() => dispatch(plusQuantityNewProduct())}
                >
                  {" "}
                  +{" "}
                </button>
